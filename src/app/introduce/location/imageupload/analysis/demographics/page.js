...
// Client-side component that uses hooks
...
export default function DemographicsPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-white text-[#1A1B1C] font-roobert">Loading demographics...</div>}>
      <DemographicsContent />
    </Suspense>
  );
}